<template>
  <a
    ...
    :title="
      Link.Link.data.attributes.Title ? Link.Link.data.attributes.Title : ''
    "
  >
    <span class="flex flex-col max-w-sm">
      <span class="text-2xl font-semibold">{{ Link.Title }}</span>
      <span class="mt-2 font-light">{{ Link.Subtitle }}</span>
    </span>
    <font-awesome-icon
